...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1 COMMENT='Representa al ciclo en la cual los premios pertenecen';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ciclo` VALUES (12,'INTATICKET CICLO','ninguna','2018-11-18','2019-12-31'),(13,'CICLO 1','ciclo 1','2018-11-30','2019-12-30');
...
CREATE TABLE `ciclo_evento` (
  ...
  CONSTRAINT `FK_CICLO_EVENTO_CICLO` FOREIGN KEY (`ciclo_id`) REFERENCES `ciclo` (`ciclo_id`),
  CONSTRAINT `FK_CICLO_EVENTO_ESTADO` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`estado_id`),
  CONSTRAINT `FK_CICLO_EVENTO_EVENTO` FOREIGN KEY (`evento_id`) REFERENCES `evento` (`evento_id`)
...
INSERT INTO `ciclo_evento` VALUES (12,12,14,1,100,'S','S',5),(13,12,15,1,200,'S','S',5);
...
CREATE TABLE `ciclo_evento_premio` (
  ...
  CONSTRAINT `FK_CIC_EVE_PRE_CIC_EVE` FOREIGN KEY (`ciclo_evento_id`) REFERENCES `ciclo_evento` (`ciclo_evento_id`),
  CONSTRAINT `FK_CIC_EVE_PRE_ESTADO` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`estado_id`)
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=latin1 COMMENT='Representa a los premios que estarán en un ciclo determinado';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ciclo_evento_premio` VALUES (42,12,29,100,100,54,1),(43,13,25,2,2,0,1),(44,13,29,198,198,1,1);
...
CREATE TABLE `configuracion_evento` (
  ...
  CONSTRAINT `FK_CON_EVE_EVE` FOREIGN KEY (`evento_id`) REFERENCES `evento` (`evento_id`),
  CONSTRAINT `FK_CON_EVE_TIP_JUE` FOREIGN KEY (`tipo_juego_id`) REFERENCES `tipo_juegos` (`tipo_juego_id`),
  CONSTRAINT `FK_CON_EVE_TIP_URL` FOREIGN KEY (`tipo_url_id`) REFERENCES `tipo_url` (`tipo_url_id`)
...
INSERT INTO `configuracion_evento` VALUES (100,14,10,'eventos/imagenes/configuracionevento_100_evento_14.png',2),(102,14,11,'eventos/imagenes/configuracionevento_102_evento_14.png',2),(103,14,12,'eventos/imagenes/configuracionevento_103_evento_14.png',2),(104,14,13,'eventos/imagenes/configuracionevento_104_evento_14.png',2),(105,14,14,'eventos/imagenes/configuracionevento_105_evento_14.png',2),(106,14,15,'eventos/imagenes/configuracionevento_106_evento_14.png',2),(107,14,16,'eventos/imagenes/configuracionevento_107_evento_14.png',2),(108,14,17,'eventos/imagenes/configuracionevento_108_evento_14.png',2),(109,14,18,'eventos/imagenes/configuracionevento_109_evento_14.png',2),(110,14,19,'eventos/imagenes/configuracionevento_110_evento_14.png',2),(111,14,21,'eventos/imagenes/configuracionevento_111_evento_14.png',2),(114,14,23,'eventos/imagenes/configuracionevento_114_evento_14.png',2),(115,14,24,'eventos/imagenes/configuracionevento_115_evento_14.png',2),(118,14,25,'eventos/imagenes/configuracionevento_118_evento_14.png',2),(119,14,20,'eventos/imagenes/configuracionevento_119_evento_14.png',2),(120,14,22,'eventos/imagenes/configuracionevento_120_evento_14.png',2);
...
CREATE TABLE `evento` (
  ...
  `estado_id` int(11) DEFAULT NULL,
  `evento_url_imagen` text,
  PRIMARY KEY (`evento_id`),
  KEY `FK_EVENTO_ESTADO_idx` (`estado_id`),
  CONSTRAINT `FK_EVENTO_ESTADO` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`estado_id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1 COMMENT='Representa el evento a jugar';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `evento` VALUES (14,'INTATICKET EVENTO','ninguna',0,1,'eventos/imagenes/evento_14.jpg'),(15,'PRUEBA','ninguna',0,1,'eventos/imagenes/evento_15.jpg');
...
CREATE TABLE `incremento_probabilidad_premio` (
  ...
  CONSTRAINT `FK_INC_PRO_PRE_CATEGORIA` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`categoria_id`),
  CONSTRAINT `FK_INC_PRO_PRE_EVENTO` FOREIGN KEY (`evento_id`) REFERENCES `evento` (`evento_id`)
...
CREATE TABLE `migracion_informacion_participante` (
  ...
  CONSTRAINT `FK_MIG_INF_PAR_EVE` FOREIGN KEY (`evento_id`) REFERENCES `evento` (`evento_id`)
...
INSERT INTO `parametro_general` VALUES (1,'TIPO_USUARIO_ADMIN','1','Representa el id del tipo de usuario administrador'),(2,'TIPO_URL_VIDEO','1','Representa el id del tipo de url para videos'),(3,'TIPO_URL_SONIDO','5','Representa el id del tipo de url para sonidos'),(4,'TIPO_USUARIO_TELEVISOR','3','Representa el id del tipo de usuario administrador'),(5,'TIPO_USUARIO_REGISTRADOR','2','Representa el id del tipo de usuario administrador'),(6,'CICLO_EVENTO_USUARIO','-1','Evento configurado desde el administrador del usuario registradoralynprueba'),(7,'IMPRESORA_ACTIVA','NO','Si existe impresora en el evento'),(8,'ESTADO_ACTIVO','1','Representa el id del tipo de usuario administrador'),(9,'ESTADO_INACTIVO','2','Representa el id del tipo de usuario administrador'),(10,'RUTA_RECURSOS','C:/wamp64/www/instaticket/recurso_juego/','Representa la ruta para acceder a los recursos (imagenes)'),(11,'URL_RECURSOS','http://localhost:8083/instaticket/recurso_juego/','Representa la url para acceder a los recursos (imagenes)'),(12,'TIPO_URL_FONDO','3','Representa el id del tipo de url para videos'),(13,'TIPO_URL_PRIMERA_PUERTA','7','Representa el id del tipo de url para videos'),(14,'TIPO_URL_SEGUNDA_PUERTA','8','Representa el id del tipo de url para videos'),(15,'TIPO_URL_TERCERA_PUERTA','9','Representa el id del tipo de url para videos');
...
CREATE TABLE `premio` (
  ...
  `premio_url_imagen` text,
  `estado_id` int(11) DEFAULT NULL,
  `categoria_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`premio_id`),
  KEY `FK_PREMIO_ESTADO_idx` (`estado_id`),
  KEY `FK_PREMIO_CATEGORIA_idx` (`categoria_id`),
  CONSTRAINT `FK_PREMIO_CATEGORIA` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`categoria_id`),
  CONSTRAINT `FK_PREMIO_ESTADO` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`estado_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=635 DEFAULT CHARSET=latin1 COMMENT='Tabla que indica los premios de los participantes que jugaron en el evento';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `premio_participante` VALUES (580,29,NULL,7,42,NULL,NULL,NULL,'2019-02-06 19:10:58',NULL),(581,29,NULL,7,42,NULL,NULL,'483877','2019-02-06 19:22:34',NULL),(582,29,NULL,7,42,NULL,NULL,NULL,'2019-02-06 19:23:41',NULL),(583,29,NULL,7,42,NULL,NULL,'775314','2019-02-06 19:25:16',NULL),(584,29,NULL,7,42,NULL,NULL,'421368','2019-02-06 19:27:01',NULL),(585,29,NULL,7,42,NULL,NULL,'373255','2019-02-06 19:32:22',NULL
',NULL),(623,29,NULL,7,42,NULL,NULL,'356356','2019-02-06 20:24:48',NULL),(624,29,NULL,7,42,NULL,NULL,'018483','2019-02-06 20:24:50',NULL),(625,29,NULL,7,42,NULL,NULL,'221645','2019-02-06 20:25:16',NULL),(626,29,NULL,7,42,NULL,NULL,'291358','2019-02-06 20:25:50',NULL),(627,29,NULL,7,42,NULL,NULL,'671159','2019-02-06 20:36:36',NULL),(628,29,NULL,7,42,NULL,NULL,'483425','2019-02-06 20:39:23',NULL),(629,29,NULL,7,42,NULL,NULL,'503776','2019-02-06 21:12:46',NULL),(630,29,NULL,7,42,NULL,NULL,'011661','2019-02-06 21:14:59',NULL),(631,29,NULL,7,44,NULL,NULL,'496110','2019-02-06 21:15:21',NULL),(632,29,NULL,7,42,NULL,NULL,'248500','2019-02-06 21:19:33',NULL),(633,29,NULL,7,42,NULL,NULL,'095523','2019-02-06 21:19:53',NULL),(634,29,NULL,7,42,NULL,NULL,'648405','2019-02-06 21:21:58',NULL);
...
INSERT INTO `probabilidades` VALUES (11,80,1,NULL,NULL);
...
INSERT INTO `tipo_juegos` VALUES (1,'Puerta Millonario','juego de 3 puertas donde se selecciona una'),(2,'Juego de Cartas','juego de cartas mayor o menor con turnos');
...
CREATE TABLE `tipo_url` (
  ...
  CONSTRAINT `fk_tipo_url_tipo_juegos` FOREIGN KEY (`tipo_juego_id`) REFERENCES `tipo_juegos` (`tipo_juego_id`)
...
INSERT INTO `tipo_url` VALUES (1,'VIDEO_PRINCIPAL','VIDEO PROMOCIONAL',1),(2,'BOTON_PRINCIPAL',NULL,1),(3,'FONDO_JUEGO',NULL,1),(4,'BOTON_JUEGO',NULL,1),(5,'SONIDO_JUEGO',NULL,1),(6,'BASE_JUEGO',NULL,1),(7,'PRIMERA_PUERTA',NULL,1),(8,'SEGUNDA_PUERTA',NULL,1),(9,'TERCERA_PUERTA',NULL,1),(10,'cards0',NULL,2),(11,'cards1',NULL,2),(12,'cards2',NULL,2),(13,'cards3',NULL,2),(14,'cards4',NULL,2),(15,'cards5',NULL,2),(16,'cards6',NULL,2),(17,'cards7',NULL,2),(18,'cards8',NULL,2),(19,'cards9',NULL,2),(20,'baraja',NULL,2),(21,'fondoCarta',NULL,2),(22,'pared',NULL,2),(23,'publicidad',NULL,2),(24,'ruleta',NULL,2),(25,'background',NULL,2);
...
INSERT INTO `tipo_usuario` VALUES (1,'ADMINISTRADOR','ADMINISTRADOR DEL SISTEMA'),(2,'REGISTRADOR','USUARIO REGISTRADOR'),(3,'TELEVISOR','');
...
CREATE TABLE `usuario` (
  ...
  CONSTRAINT `usuarios_estado_id` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`estado_id`)
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `obtener_ganador`(IN P_EVENTO_ID INT,IN P_CICLOEVENTO_ID INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `obtener_premios`(IN P_EVENTO_ID INT)
BEGIN
DECLARE V_CANTIDAD_CATEGORIAS INT DEFAULT 6;
DECLARE V_CONTADOR_CATEGORIAS INT DEFAULT 1;
DECLARE V_CATEGORIA INT;
...
-- Dump completed on 2019-02-06 21:26:46
